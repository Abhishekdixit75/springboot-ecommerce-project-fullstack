...
class ProductServiceImplTest {
  ...
  void testAddProductSuccess() {
    ...
    // doNothing().when(productRepository).deleteById(1L);    --> this is used when the return type
    ...
    // Verify interactions: verifying that the mocked dependencies were called with the expected
    // arguments and number of times
