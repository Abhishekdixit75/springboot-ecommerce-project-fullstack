...
public class CategoryController {
  ...
  //    public CategoryController(CategoryService categoryService) { NO NEED TO USE THIS, AS WE ARE
  ...
  // @RequestMapping(value = "/api/public/categories" , method = RequestMethod.GET)  -  another way
  // to get mapping of the GET method
