...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getProductsByCategory(
            ...
            @RequestParam(name = "sortOrder", defaultValue = AppConstants.SORT_DIR, required = false) String sortOrder,
            @PathVariable Long categoryId) {
        ProductResponse productResponse = productService.searchByCategory(pageNumber, pageSize, sortBy, sortOrder,
                categoryId);
        return new ResponseEntity<>(productResponse, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ProductResponse> getProductsByKeyword(
        ...
        ProductResponse productResponse = productService.searchProductByKeyword(pageNumber, pageSize, sortBy, sortOrder,
                keyword);
    ...
    public ResponseEntity<ProductDTO> addProductForSeller(
            @Valid @RequestBody ProductDTO productDTO,
            @PathVariable Long categoryId) {
        ProductDTO savedProductDTO = productService.addProduct(categoryId, productDTO);
        return new ResponseEntity<>(savedProductDTO, HttpStatus.CREATED);
