...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse getAllOrders(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        Sort sortByAndOrder = sortOrder.equalsIgnoreCase("acs") ? Sort.by(sortBy).ascending() : Sort.by(sortBy).descending();
    ...
    public OrderResponse getAllSellerOrders(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        Page<Order> pageOrders = orderRepository.findAll(pageDetails);
        List<Order> sellerOrders = pageOrders.getContent().stream().filter(order -> order.getOrderItems().stream().anyMatch(orderItem -> {
        ...
        // we are filtering orders which have at least one order item which belongs to the logged in seller
