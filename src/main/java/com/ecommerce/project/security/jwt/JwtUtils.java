...
public class JwtUtils {
  private static final Logger logger =
      LoggerFactory.getLogger(
          JwtUtils
              .class); // logger is a tool used to record messages, it also adds the logs onto the

  // console (similar to system.out.println()) with all the additional details
  ...
  public String generateTokenFromUsername(
      String username) { // Creates a new JWT for an authenticated user.
    return Jwts.builder()
        .subject(username)
        .issuedAt(new Date())
