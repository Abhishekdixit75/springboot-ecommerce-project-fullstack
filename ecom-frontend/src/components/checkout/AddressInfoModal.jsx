		...
		<div>
			...
			>
				...
				<div className="fixed inset-0 flex w-screen items-center justify-center p-4">
					...
					<DialogPanel className="relative w-full max-w-md mx-auto transform overflow-hidden bg-white rounded-lg transition-all">
						<div className="px-6 py-6">
							{children}
						</div>
						<div className="flex justify-end gap-4 absolute right-4 top-2">
							<button onClick={() => setOpen(false)} type="button">
								<FaTimes className ="text-rose-700 cursor-pointer" size={25} />
							</button>
						</div>
					</DialogPanel>
				</div>
