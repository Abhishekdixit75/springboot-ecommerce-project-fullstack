	...
	return (
		<div className="lg:px-14 sm:px-8 px-4 py-10">
			<div className="flex flex-col items-center mb-12">
				<h1 className="text-4xl font-bold text-grey-900 flex items-center gap-3">
			...
			<div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4">
				...
				<div className="flex text-sm gap-1 flex-col">
					...
					<Link className="w-full flex justify-end" to="/checkout">
						<button
							onClick={() => {}}
							className="font-semibold w-[300px] py-2 rounded-sm bg-custom-blue text-white flex items-center justify-center hover:text-gray-300 transition duration-500"
						>
							<MdShoppingCart sixe={20} />
							Checkout
						</button>
					</Link>
