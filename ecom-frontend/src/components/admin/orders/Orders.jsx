...
const Orders = () => {
	...
	useOrderFilter(); //fetch the order data for the admin dashboard and set it in the redux store. It is used in the Orders component to display the order data in the OrderTable component.
