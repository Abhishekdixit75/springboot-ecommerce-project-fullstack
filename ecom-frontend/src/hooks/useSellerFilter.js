...
function useSellerFilter() {
    ...
    useEffect(() => { // we use useEffect hook to fetch the sellers from the backend and set it in the redux store when the component mounts and when the search parameters change.
